package com.mivio.editor.customviews
...
class DraggableImageOverlayView @JvmOverloads constructor(
    ...
    // ── Public callbacks ──────────────────────────────────────────────────────
    var onImageCommitted: ((uri: Uri, relativeX: Float, relativeY: Float, relativeWidth: Float, relativeHeight: Float, rotationAngle: Float, opacity: Float, isMirrored: Boolean, maskConfig: com.mivio.editor.models.EditOperation.MaskConfig) -> Unit)? = null
    var onPositionChanged: ((relativeX: Float, relativeY: Float) -> Unit)? = null
    var onMaskChanged: ((com.mivio.editor.models.EditOperation.MaskConfig) -> Unit)? = null
    ...
    var maskConfig = com.mivio.editor.models.EditOperation.MaskConfig()
    ...
    fun activate(uri: Uri, aspect: Float = 1.0f) {
        ...
        maskConfig = com.mivio.editor.models.EditOperation.MaskConfig()
        post {
            updateImageViewSizeAndPosition()
        }
    }

    fun activateForEdit(op: com.mivio.editor.models.EditOperation.AddImageOverlay) {
        isEditingActive = true
    ...
    override fun dispatchDraw(canvas: Canvas) {
        val hasMask = maskConfig.shape != com.mivio.editor.models.EditOperation.MaskShape.NONE
        if (hasMask && isEditingActive && imageUri != null) {
            ...
            when (maskConfig.shape) {
                com.mivio.editor.models.EditOperation.MaskShape.RECTANGLE -> {
                    path.addRect(cx - mw/2, cy - mh/2, cx + mw/2, cy + mh/2, android.graphics.Path.Direction.CW)
                }
                com.mivio.editor.models.EditOperation.MaskShape.ELLIPSE -> {
                    path.addOval(cx - mw/2, cy - mh/2, cx + mw/2, cy + mh/2, android.graphics.Path.Direction.CW)
                }
                com.mivio.editor.models.EditOperation.MaskShape.SPLIT -> {
                ...
                com.mivio.editor.models.EditOperation.MaskShape.SHUTTER -> {
                ...
                com.mivio.editor.models.EditOperation.MaskShape.HEART -> {
                    createHeartPath(path, cx, cy, mw, mh)
                }
                com.mivio.editor.models.EditOperation.MaskShape.STAR -> {
