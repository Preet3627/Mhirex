package com.mhirex.editor.customviews
...
class DraggableImageOverlayView @JvmOverloads constructor(
    ...
    // ── Public callbacks ──────────────────────────────────────────────────────
    var onImageCommitted: ((uri: Uri, relativeX: Float, relativeY: Float, relativeWidth: Float, relativeHeight: Float, rotationAngle: Float, opacity: Float, isMirrored: Boolean, maskConfig: com.mhirex.editor.models.EditOperation.MaskConfig) -> Unit)? = null
    var onPositionChanged: ((relativeX: Float, relativeY: Float) -> Unit)? = null
    var onMaskChanged: ((com.mhirex.editor.models.EditOperation.MaskConfig) -> Unit)? = null
    ...
    var maskConfig = com.mhirex.editor.models.EditOperation.MaskConfig()
    ...
    fun activate(uri: Uri, aspect: Float = 1.0f) {
        ...
        maskConfig = com.mhirex.editor.models.EditOperation.MaskConfig()
        post {
            updateImageViewSizeAndPosition()
        }
    }

    fun activateForEdit(op: com.mhirex.editor.models.EditOperation.AddImageOverlay) {
        isEditingActive = true
    ...
    override fun dispatchDraw(canvas: Canvas) {
        val hasMask = maskConfig.shape != com.mhirex.editor.models.EditOperation.MaskShape.NONE
        if (hasMask && isEditingActive && imageUri != null) {
            ...
            when (maskConfig.shape) {
                com.mhirex.editor.models.EditOperation.MaskShape.RECTANGLE -> {
                    path.addRect(cx - mw/2, cy - mh/2, cx + mw/2, cy + mh/2, android.graphics.Path.Direction.CW)
                }
                com.mhirex.editor.models.EditOperation.MaskShape.ELLIPSE -> {
                    path.addOval(cx - mw/2, cy - mh/2, cx + mw/2, cy + mh/2, android.graphics.Path.Direction.CW)
                }
                com.mhirex.editor.models.EditOperation.MaskShape.SPLIT -> {
                ...
                com.mhirex.editor.models.EditOperation.MaskShape.SHUTTER -> {
                ...
                com.mhirex.editor.models.EditOperation.MaskShape.HEART -> {
                    createHeartPath(path, cx, cy, mw, mh)
                }
                com.mhirex.editor.models.EditOperation.MaskShape.STAR -> {
