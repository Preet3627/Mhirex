...
class MediaPublisherInstrumentedTest {
    ...
    private val runTag = "mivio_test_${System.currentTimeMillis()}"
    ...
    fun publish_toMediaStore_yieldsReadableContentUri_withIntactBytes() {
        ...
        val outcome = MediaPublisher.publish(
            ...
            source = source,
            mimeType = "video/mp4",
            displayName = "mivio_pubtest_$runTag.mp4",
    ...
    fun publish_cancelled_leavesNoRowBehind() {
        ...
        val outcome = MediaPublisher.publish(
            ...
            source = source,
            mimeType = "video/mp4",
            displayName = "mivio_pubtest_cancel_$runTag.mp4",
            collection = MediaPublisher.Collection.VIDEO,
            customTreeUri = null,
            isCancelled = { true },
        )
    ...
    fun publish_missingSource_failsWithoutCreatingRow() {
        ...
        val outcome = MediaPublisher.publish(
            ...
            source = missing,
            mimeType = "video/mp4",
            displayName = "mivio_pubtest_missing_$runTag.mp4",
            collection = MediaPublisher.Collection.VIDEO,
            customTreeUri = null,
        )
    ...
    fun publish_imageCollection_landsInPicturesMhireX() {
        ...
        val outcome = MediaPublisher.publish(
            ...
            source = source,
            mimeType = "image/png",
            displayName = "mivio_pubtest_$runTag.png",
    ...
    fun publish_success_clearsIsPending() {
        ...
        val outcome = MediaPublisher.publish(
            ...
            source = source,
            mimeType = "video/mp4",
            displayName = "mivio_pubtest_pending_$runTag.mp4",
            collection = MediaPublisher.Collection.VIDEO,
            customTreeUri = null,
        )
